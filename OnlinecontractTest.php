...
//наименование товара, количество и цена
// $product = ['A' => [0, 100],
//             'B' => [0, 100],
//             'D' => [0, 100],
//             'C' => [0, 100],
...
$product = new Order('A', 1, 100);
// $product -> name =  'A';
// $product -> amount = 1; // количество
// $product -> peice = 100; // цена
...
class discount_10{
  public $A;
  public $B;
  public function add_to_disc_10(){
    
  }
}

$basket = [$A=>3, $B=>2, $G=>3]; //корзина с товаром


foreach ($backet as $product){
  
}



$basket_discount;//корзина со скидкой
?>